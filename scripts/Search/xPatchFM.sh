...
d_pairs=("32 128""128 256" "256 512" "256 1024" "512 2048")
losses=("MAE" "MSE")
channels=("CD" "CI")
e_layers_list=(1 2 3)
                  ...
                  for n_heads in "${n_heads_list[@]}"; do
                      for loss in "${losses[@]}"; do
                          for channel in "${channels[@]}"; do
                              ...
                              model_id="${dataset}_${seq_len}_${pred_len}_${d_model}_${d_ff}_${loss}_${channel}_e${e_layers}_h${n_heads}_${model_name}"
